...
import me.taromati.doneconnector.skript.ChzzkDonationEvent;
...
//                    Logger.info(ChatColor.RED + "치지직 웹소켓 핑 스레드가 종료되었습니다.");
    ...
    private void call(String tag, String nickname, int payAmount, String msg, String command) {
        // Fire Skript event
        ChzzkDonationEvent event = new ChzzkDonationEvent(tag, nickname, payAmount, msg);
        Bukkit.getScheduler().callSyncMethod(DoneConnector.plugin, () -> {
